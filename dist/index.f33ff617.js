...
})({"cAVq7":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "6397f796f33ff617";
"use strict";
...
function remove(value) {
    ...
    for(let i = 0; i < numberOfNodes; i++){
        if (currentNode.value == value) targetIndex = i;
        currentNode = currentNode.next;
    }
    if (targetIndex == null) console.log(`${value}를 찾을 수 없습니다.`);
...
//# sourceMappingURL=index.f33ff617.js.map
